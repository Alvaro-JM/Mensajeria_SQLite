...
public class Ventana extends javax.swing.JFrame {
    ...
    public Ventana() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Problema en la comunicación con la base de datos", "Error", JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
        }
    }
    ...
    private void jButton_empresa_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_empresa_guardarActionPerformed
        ...
        } else if(!datosUnicosEmpresas(nombre_empresa, cif, web)){
            JOptionPane.showMessageDialog(this, "El nombre de la empresa, el cif y la web no pueden coincidir con los mismos de otra empresa",
                    "Atención", JOptionPane.WARNING_MESSAGE);
        } else {
            try {
                if (aniadirEmpresa) {
    ...
    private void jButton_oficina_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_oficina_guardarActionPerformed
        ...
        } else if(!datosUnicosOficinas(direccion_oficina, telefono_oficina, email)){
            JOptionPane.showMessageDialog(this, "La dirección de la oficina, el teléfono y el email no pueden coincidir con los mismos de otra oficina",
                    "Atención", JOptionPane.WARNING_MESSAGE);
        } else {
            try {
    ...
    private void jButton_repartidor_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_repartidor_guardarActionPerformed
        ...
        if (dni.equals("") || nombre_repartidor.equals("") || telefono_repartidor.equals("") || jTextField_repartidor_antiguedad.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "No se permiten campos vacíos", "Atención", JOptionPane.WARNING_MESSAGE);
        } else if(!datosUnicosRepartidores(dni, telefono_repartidor)){
            JOptionPane.showMessageDialog(this, "El DNI del repartidor y el teléfono no pueden coincidir con los mismos de otro repartidor",
                    "Atención", JOptionPane.WARNING_MESSAGE);
        } else {
            try {
    ...
    private void cargarListas() throws SQLException {
        ...
        empresaControlador.leerEmpresa();
    ...
    private boolean datosUnicosEmpresas(String nombre_empresa, String cif, String web){
        Boolean datosUnicos = true;
        Iterator<Empresa> it = listaEmpresasMostradas.iterator();
        
        if (aniadirEmpresa) {
            while (it.hasNext() && datosUnicos) {
                Empresa empresa = it.next();
                if (nombre_empresa.equals(empresa.getNombre_empresa())) {
                    datosUnicos = false;
                }
                if (cif.equals(empresa.getCif())) {
                    datosUnicos = false;
                }
                if (web.equals(empresa.getWeb())) {
                    datosUnicos = false;
                }
            }
            
        } else if (modificarEmpresa) {
            int id_empresa = listaEmpresasMostradas.get(filaEmpresa).getId_empresa();
            while (it.hasNext() && datosUnicos) {
                Empresa empresa = it.next();
    ...
    private boolean datosUnicosOficinas(String direccion_oficina, String telefono_oficina, String email){
        Boolean datosUnicos = true;
        Iterator<Oficina> it = listaOficinasMostradas.iterator();
        
        if (aniadirOficina) {
            while (it.hasNext() && datosUnicos) {
                Oficina oficina = it.next();
                if (direccion_oficina.equals(oficina.getDireccion_oficina())) {
                    datosUnicos = false;
                }
                if (telefono_oficina.equals(oficina.getTelefono_oficina())) {
                    datosUnicos = false;
                }
                if (email.equals(oficina.getEmail())) {
                    datosUnicos = false;
                }
            }
            
        } else if (modificarOficina) {
            int id_oficina = listaOficinasMostradas.get(filaOficina).getId_oficina();
            while (it.hasNext() && datosUnicos) {
                Oficina oficina = it.next();
                if (oficina.getId_oficina() != id_oficina) {
                    if (direccion_oficina.equals(oficina.getDireccion_oficina())) {
                        datosUnicos = false;
                    }
                    if (telefono_oficina.equals(oficina.getTelefono_oficina())) {
    ...
    private boolean datosUnicosRepartidores(String dni, String telefono_repartidor){
        Boolean datosUnicos = true;
        Iterator<Repartidor> it = listaRepartidoresMostrados.iterator();
        
        if (aniadirRepartidor) {
            while (it.hasNext() && datosUnicos) {
                Repartidor repartidor = it.next();
                if (dni.equals(repartidor.getDni())) {
                    datosUnicos = false;
                }
                if (telefono_repartidor.equals(repartidor.getTelefono_repartidor())) {
                    datosUnicos = false;
                }
            }
            
        } else if (modificarRepartidor) {
            int id_repartidor = listaRepartidoresMostrados.get(filaRepartidor).getId_repartidor();
            while (it.hasNext() && datosUnicos) {
                Repartidor repartidor = it.next();
                if (repartidor.getId_repartidor() != id_repartidor) {
                    if (dni.equals(repartidor.getDni())) {
                        datosUnicos = false;
                    }
                    if (telefono_repartidor.equals(repartidor.getTelefono_repartidor())) {
    ...
    public void aniadirEmpresa(String nombre_empresa, String cif, String director, String web) throws SQLException {
        empresaControlador.insertarEmpresa(nombre_empresa, cif, director, web);
    }
    
    public void modificarEmpresa(int filaSeleccionada, String nombre_empresa, String cif, String director, String web) throws SQLException {
        int id_empresa = listaEmpresasMostradas.get(filaSeleccionada).getId_empresa();
        empresaControlador.modificarEmpresa(id_empresa, nombre_empresa, cif, director, web);
    }
    
    public void eliminarEmpresa(int id_empresaEliminar) throws SQLException {
        empresaControlador.eliminarEmpresa(id_empresaEliminar);
    }
    ...
    private void aniadirOficina(String direccion_oficina, String telefono_oficina, String email, String encargado, int empresa) throws SQLException {
        oficinaControlador.insertarOficina(direccion_oficina, telefono_oficina, email, encargado, empresa);
    }
    
    private void modificarOficina(int filaSeleccionada, String direccion_oficina, String telefono_oficina, String email, String encargado, int empresa) throws SQLException{
        int id_oficina = listaOficinasMostradas.get(filaSeleccionada).getId_oficina();
        oficinaControlador.modificarOficina(id_oficina, direccion_oficina, telefono_oficina, email, encargado, empresa);
    }
    
    private void eliminarOficina(int id_oficinaEliminar) throws SQLException {
        oficinaControlador.eliminarOficina(id_oficinaEliminar);
    }
    ...
    private void aniadirRepartidor(String dni, String nombre_repartidor, String telefono_repartidor, int antiguedad, int oficina) throws SQLException {
        repartidorControlador.insertarRepartidor(dni, nombre_repartidor, telefono_repartidor, antiguedad, oficina);
    }
    
    private void modificarRepartidor(int filaSeleccionada, String dni, String nombre_repartidor, String telefono_repartidor, int antiguedad, int oficina) throws SQLException{
        int id_repartidor = listaRepartidoresMostrados.get(filaSeleccionada).getId_repartidor();
        repartidorControlador.modificarRepartidor(id_repartidor, dni, nombre_repartidor, telefono_repartidor, antiguedad, oficina);
    }
                
    private void eliminarRepartidor(int id_repartidorEliminar) throws SQLException {
        repartidorControlador.eliminarRepartidor(id_repartidorEliminar);
    }
    ...
    private void aniadirPaquete(Date fecha_entrega, String direccion_destino, String telefono_destino, String direccion_origen, String telefono_origen, int repartidor) throws SQLException{
        paqueteControlador.insertarPaquete(fecha_entrega, direccion_destino, telefono_destino, direccion_origen, telefono_origen, repartidor);
    }
    
    private void modificarPaquete(int filaSeleccionada, Date fecha_entrega, String direccion_destino, String telefono_destino, String direccion_origen, String telefono_origen, int repartidor) throws SQLException{
        int id_paquete = listaPaquetesMostrados.get(filaSeleccionada).getId_paquete();
        paqueteControlador.modificarPaquete(id_paquete, fecha_entrega, direccion_destino, telefono_destino, direccion_origen, telefono_origen, repartidor);
    }
    
    private void eliminarPaquete(int id_paqueteEliminar) throws SQLException {
        paqueteControlador.eliminarPaquete(id_paqueteEliminar);
    }
